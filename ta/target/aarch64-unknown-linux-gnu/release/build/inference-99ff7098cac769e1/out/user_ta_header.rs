...
const TA_STACK_SIZE: u32 = 1048576u32;
const TA_VERSION: &[u8] = b"0.4.0\0";
const TA_DESCRIPTION: &[u8] = b"An inference TA of MNIST model.\0";
#[no_mangle]
...
pub static ta_head: optee_utee_sys::ta_head = optee_utee_sys::ta_head {
    uuid: optee_utee_sys::TEE_UUID {
        timeLow: 3993610890u32,
        timeMid: 64441u16,
        timeHiAndVersion: 18228u16,
        clockSeqAndNode: [174u8, 140u8, 215u8, 205u8, 26u8, 63u8, 103u8, 68u8],
    },
    stack_size: 1056768u32,
    flags: TA_FLAGS,
    depr_entry: u64::MAX,
};
#[no_mangle]
