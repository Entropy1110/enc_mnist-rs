...
#[allow(dead_code)]
pub static TARGET: &str = "aarch64-unknown-linux-gnu";
...
#[allow(dead_code)]
pub static RUSTC: &str = "/root/.rustup/toolchains/nightly-2025-05-16-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/root/.rustup/toolchains/nightly-2025-05-16-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/root/.rustup/toolchains/nightly-2025-05-16-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.89.0-nightly (d97326eab 2025-05-15)";
#[doc=r#"The output of `/root/.rustup/toolchains/nightly-2025-05-16-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/root/.rustup/toolchains/nightly-2025-05-16-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.89.0-nightly (d97326eab 2025-05-15)";
